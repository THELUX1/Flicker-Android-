      ...
      },
{
      ...
      {
          id: 1233413,
          title: "Sinners: Pecadores",
          image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaVv36waPpovRV89SR10h9l4_u-NB3vU3HSQ&s",
      ...
      },
      {
          ...
          image: "https://m.media-amazon.com/images/M/MV5BODU5MzQ2YjItYzA1ZC00ZTMxLWEzNDEtZWQ1OWUwYWE3NzM1XkEyXkFqcGc@._V1_.jpg",
    ...
    },
    {
        ...
        year: "2025",
        genres: ["Suspenso","Romance","Ciencia ficción"]
    },
    {
...
export const seriesData = [
...
},
    {
        ...
        image: "https://media.themoviedb.org/t/p/w220_and_h330_face/u3bZgnGQ9T01sWNhyveQz0wH0Hl.jpg",
    ...
    },
    {
        ...
        image: "https://media.themoviedb.org/t/p/w220_and_h330_face/vUUqzWa2LnHIVqkaKVlVGkVcZIW.jpg",
        link: "detalles.html?type=tv&id=60574",
        year: "2013-2022",
        genres: ["Drama", "Crimen"],
...
export function getAllAvailableIds() {
    const movieIds = moviesData.map(movie => movie.id.toString());
    const seriesIds = seriesData.map(series => series.id.toString());
    return [...movieIds, ...seriesIds];
}

// Función para buscar un item por ID y tipo
export function getMediaByIdAndType(id, type) {
    const collection = type === 'movie' ? moviesData : seriesData;
    return collection.find(item => item.id.toString() === id.toString());
}

// Función para obtener similares disponibles
export function getAvailableSimilar(currentId, currentType) {
